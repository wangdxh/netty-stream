 ...
 * The version of SIP.
 */
public final class SipVersions {

    /**
     * SIP/2.0
     */
    public static final HttpVersion SIP_2_0 = new HttpVersion("SIP", 2, 0, true);
     ...
     * equal to {@code "SIP/2.0"}, {@link #SIP_2_0} will be returned.
